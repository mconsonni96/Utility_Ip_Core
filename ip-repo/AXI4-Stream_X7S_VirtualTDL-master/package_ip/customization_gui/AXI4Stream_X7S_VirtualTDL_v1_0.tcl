...
proc init_gui { IPINST } {
  ...
  set FILE_PATH_NAME_CO_DELAY [ipgui::add_param $IPINST -name "FILE_PATH_NAME_CO_DELAY" -parent ${Simulation_vs_Implementation}]
  set_property tooltip {CO Delay Path Used for simulated TDL} ${FILE_PATH_NAME_CO_DELAY}
  set FILE_PATH_NAME_O_DELAY [ipgui::add_param $IPINST -name "FILE_PATH_NAME_O_DELAY" -parent ${Simulation_vs_Implementation}]
...
proc update_PARAM_VALUE.MIN_VALID_TAP_POS { PARAM_VALUE.MIN_VALID_TAP_POS PARAM_VALUE.DEBUG_MODE PARAM_VALUE.MAX_VALID_TAP_POS} {
	# Procedure called to update MIN_VALID_TAP_POS when any of the dependent parameters in the arguments change
...
proc update_PARAM_VALUE.VALID_POSITION_TAP_INIT { PARAM_VALUE.VALID_POSITION_TAP_INIT PARAM_VALUE.BIT_SMP_TDL } {
    ...
    set MAX_VALID_POSITION_TAP_INIT [expr $values(BIT_SMP_TDL) -1]
