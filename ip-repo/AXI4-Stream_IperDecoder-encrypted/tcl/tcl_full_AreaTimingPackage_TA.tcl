...
append	description	"--								TOTAL CONFIGUARTION   								   --\n"
append	description	"----------------------------------------------------------------------------------------\n"
append	description	"----------------------------------------------------------------------------------------\n"
					...
					for {set max_input_engine_2 [lindex $max_input_engine_range 0]} {$max_input_engine_2 <= [lindex $max_input_engine_range 1]} {incr max_input_engine_2} {
						for {set max_input_engine_3 [lindex $max_input_engine_range 0]} {$max_input_engine_3 <= [lindex $max_input_engine_range 1]} {incr max_input_engine_3} {
							...
							for	{set bit_input [lindex $bit_input_range 0]} {$bit_input <= [lindex $bit_input_range 1]} {incr bit_input}	{
								...
								set results([list $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input]) [lindex $results_list $i]
								incr i
					...
					for {set max_input_engine_2 [lindex $max_input_engine_range 0]} {$max_input_engine_2 <= [lindex $max_input_engine_range 1]} {incr max_input_engine_2} {
						...
						for {set max_input_engine_3 [lindex $max_input_engine_range 0]} {$max_input_engine_3 <= [lindex $max_input_engine_range 1]} {incr max_input_engine_3} {
							...
							for	{set bit_input [lindex $bit_input_range 0]} {$bit_input <= [lindex $bit_input_range 1]}	{incr bit_input}	{
								...
								set tmp $results([list $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input])
								...
								append constant_array_record "\tMAX_INPUT_ENGINE_2 = $max_input_engine_2,\tMAX_INPUT_ENGINE_3 = $max_input_engine_3,\tBIT_INPUT = $bit_input\n"
...
proc computeRecord_synth_design {free_running number_of_input max_input_engine_0 max_input_engine_1 max_input_engine_2  max_input_engine_3 bit_input} \
{
...
proc computeRecord_launch_run {free_running number_of_input max_input_engine_0 max_input_engine_1 max_input_engine_2  max_input_engine_3 bit_input regenerate_run} \
{
		...
		for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
			for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
				for {set max_input_engine_3 $MIN_INPUT_ENGINE} {$max_input_engine_3 <= $MAX_INPUT_ENGINE} {incr max_input_engine_3} {
					...
					if { $number_of_input < $min_number_of_input_stage_0 & $number_of_input < $min_number_of_input_stage_1 & $number_of_input < $min_number_of_input_stage_2  & $number_of_input < $min_number_of_input_stage_3} {
						...
						set generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3]) [list $number_of_input $max_input_engine_0_res $MIN_INPUT_ENGINE $MIN_INPUT_ENGINE $MIN_INPUT_ENGINE]
						# Debug value with 0 index
						# set generic_array_flt_dbg ([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3]) [list $number_of_input $max_input_engine_0_res $MIN_INPUT_ENGINE $MIN_INPUT_ENGINE $MIN_INPUT_ENGINE "0"]					}
				}
			}
		}
	}
			...
			for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
				for {set max_input_engine_3 $MIN_INPUT_ENGINE} {$max_input_engine_3 <= $MAX_INPUT_ENGINE} {incr max_input_engine_3} {
					...
					if { $number_of_input >= $min_number_of_input_stage_0 & $number_of_input < $min_number_of_input_stage_1 & $number_of_input < $min_number_of_input_stage_2  & $number_of_input < $min_number_of_input_stage_3} {
						...
						set generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3]) [list $number_of_input $max_input_engine_0 $max_input_engine_1_res $MIN_INPUT_ENGINE $MIN_INPUT_ENGINE]
						# Debug value with 1 index
						# set generic_array_flt_dbg([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3]) [list $number_of_input $max_input_engine_0 $max_input_engine_1_res $MIN_INPUT_ENGINE $MIN_INPUT_ENGINE "1"]
					}
				}
			}
...
# IF NUMBER_OF_INPUT >= MAX_INPUT_ENGINE_PIPELINE_STAGE0*MAX_INPUT_ENGINE_PIPELINE_STAGE1*MAX_INPUT_ENGINE_PIPELINE_STAGE2
			...
			for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
				for {set max_input_engine_3 $MIN_INPUT_ENGINE} {$max_input_engine_3 <= $MAX_INPUT_ENGINE} {incr max_input_engine_3} {
					...
					if { $number_of_input >= $min_number_of_input_stage_0 & $number_of_input >= $min_number_of_input_stage_1 & $number_of_input < $min_number_of_input_stage_2  & $number_of_input < $min_number_of_input_stage_3} {
						...
						set max_input_engine_2_res [div_exc [div_exc $number_of_input $max_input_engine_0] $max_input_engine_1]

						if { $max_input_engine_2_res == 1} {
							set max_input_engine_2_res $MIN_INPUT_ENGINE
						}

						set generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3]) [list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2_res $MIN_INPUT_ENGINE]
						# Debug value with 2 index
						# set generic_array_flt_dbg([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3]) [list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2_res $MIN_INPUT_ENGINE "2"]
			...
			for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
				for {set max_input_engine_3 $MIN_INPUT_ENGINE} {$max_input_engine_3 <= $MAX_INPUT_ENGINE} {incr max_input_engine_3} {
					...
					if { $number_of_input >= $min_number_of_input_stage_0 & $number_of_input >= $min_number_of_input_stage_1 & $number_of_input >= $min_number_of_input_stage_2  & $number_of_input < $min_number_of_input_stage_3} {
						...
						set max_input_engine_3_res  [div_exc [div_exc [div_exc [div_exc $number_of_input $max_input_engine_0] $max_input_engine_1] $max_input_engine_2] $max_input_engine_3]

						if { $max_input_engine_3_res == 1} {
							set max_input_engine_3_res $MIN_INPUT_ENGINE
						}

						set generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3]) [list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3_res]
						# Debug value with 3 index
						# set generic_array_flt_dbg([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3]) [list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3_res "3"]
					}
				}
			}
		}
...
# IF NUMBER_OF_INPUT >= MAX_INPUT_ENGINE_PIPELINE_STAGE0*MAX_INPUT_ENGINE_PIPELINE_STAGE1*MAX_INPUT_ENGINE_PIPELINE_STAGE2*MAX_INPUT_ENGINE_PIPELINE_STAGE3
		...
		for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
			for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
				for {set max_input_engine_3 $MIN_INPUT_ENGINE} {$max_input_engine_3 <= $MAX_INPUT_ENGINE} {incr max_input_engine_3} {
					...
					if { $number_of_input >= $min_number_of_input_stage_0 & $number_of_input >= $min_number_of_input_stage_1 & $number_of_input >= $min_number_of_input_stage_2  & $number_of_input >= $min_number_of_input_stage_3} {
						set generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3]) [list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3]

						# Debug value with 4 index
						# set generic_array_flt_dbg([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3]) [list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 "4"]
					}
				...
				for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
					for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
						for {set max_input_engine_3 $MIN_INPUT_ENGINE} {$max_input_engine_3 <= $MAX_INPUT_ENGINE} {incr max_input_engine_3} {
							...
							incr total_cores
							set generics_array_flt_set	$generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3])

							# If the generics set is new
							if { $generics_array_flt_set != $ref } {
								# Target as To Synth
								set full_generic_array_flt([list $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input])  [concat [list $free_running] $generics_array_flt_set [list $bit_input "TO_SYNTH"]]
								set ref $generics_array_flt_set
								incr cores_to_synth
							} else {
								# Target as To Copy
								set full_generic_array_flt([list $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input]) [concat [list $free_running] $generics_array_flt_set [list $bit_input "to_copy"]]
								incr cores_to_copy
							}
					...
					for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
						for {set max_input_engine_3 $MIN_INPUT_ENGINE} {$max_input_engine_3 <= $MAX_INPUT_ENGINE} {incr max_input_engine_3} {
							...
							if { $generics_array_flt_set != $ref } {
								...
								# To Synth
								# set results([list $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input]) [computeRecord_launch_run $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input $REGENERATE_RUN]
								set results([list $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input]) [computeRecord_synth_design $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input]

								set ref $generics_array_flt_set
								set index [list $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input]

								incr cores_to_synth

							} else {
								# Target as To Copy
								set results([list $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input]) $results($index)
				...
				for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
					for {set max_input_engine_3 $MIN_INPUT_ENGINE} {$max_input_engine_3 <= $MAX_INPUT_ENGINE} {incr max_input_engine_3} {
						...
						for	{set bit_input $MIN_BIT_INPUT} {$bit_input <= $MAX_BIT_INPUT}	{incr bit_input}	{
							...
							set min_propagation_delay_tmp	[ lindex $results([list $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input]) 4]
				...
				for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
					for {set max_input_engine_3 $MIN_INPUT_ENGINE} {$max_input_engine_3 <= $MAX_INPUT_ENGINE} {incr max_input_engine_3} {
						...
						for	{set bit_input $MIN_BIT_INPUT} {$bit_input <= $MAX_BIT_INPUT}	{incr bit_input}	{
							...
							lappend results_list $results([list $free_running $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 $bit_input])
...
# Find the results and puts in array
unset generic_array
array set generic_array {}

unset generic_array_flt
array set generic_array_flt {}

# Genera tutti i Generic Veri
for	{set number_of_input $MIN_NUMBER_OF_INPUT} {$number_of_input <= $MAX_NUMBER_OF_INPUT} {incr number_of_input}	{
	...
	for {set max_input_engine_0 $MIN_INPUT_ENGINE} {$max_input_engine_0 <= $MAX_INPUT_ENGINE} {incr max_input_engine_0} {
		for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
			for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
				...
				set generic_array([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2]) [list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2]
...
# A
# Non si utilizzano tuitti gli inpuit della porima pipeline
for	{set number_of_input $MIN_NUMBER_OF_INPUT} {$number_of_input <= $MAX_NUMBER_OF_INPUT} {incr number_of_input}	{
	...
	for {set max_input_engine_0 $MIN_INPUT_ENGINE} {$max_input_engine_0 <= $MAX_INPUT_ENGINE} {incr max_input_engine_0} {
		for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
			for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
				...
				if { $number_of_input < $max_input_engine_0 } {

					set generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2]) [list $number_of_input $number_of_input $MIN_INPUT_ENGINE $MIN_INPUT_ENGINE "A"]
				}
			}
		}
	}
...
# B
# Si utilizzano tutti gli inpout della prima pipeline ma non della seconda e della terza
for	{set number_of_input $MIN_NUMBER_OF_INPUT} {$number_of_input <= $MAX_NUMBER_OF_INPUT} {incr number_of_input}	{
	...
	for {set max_input_engine_0 $MIN_INPUT_ENGINE} {$max_input_engine_0 <= $MAX_INPUT_ENGINE} {incr max_input_engine_0} {
		for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
			for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
				...
				if { $number_of_input >= $max_input_engine_0 & $number_of_input < [expr $max_input_engine_0*$max_input_engine_1] & $number_of_input < [expr $max_input_engine_0*$max_input_engine_1*$max_input_engine_2]} {
					...
					set generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 ]) [list $number_of_input $max_input_engine_0 $max_input_engine_1_res  $MIN_INPUT_ENGINE "B"]
...
# C
# Si utilizzano tutti gli inpout della prima e della seconda pipeline ma non della  terza
for	{set number_of_input $MIN_NUMBER_OF_INPUT} {$number_of_input <= $MAX_NUMBER_OF_INPUT} {incr number_of_input}	{
		...
		for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
			for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
				...
				if { $number_of_input >= $max_input_engine_0 & $number_of_input >= [expr $max_input_engine_0*$max_input_engine_1] & $number_of_input < [expr $max_input_engine_0*$max_input_engine_1*$max_input_engine_2]} {
					...
					set generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 ]) [list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2_res "C"]
...
# D
# Si utilizzano tutti gli input
for	{set number_of_input $MIN_NUMBER_OF_INPUT} {$number_of_input <= $MAX_NUMBER_OF_INPUT} {incr number_of_input}	{

	for {set max_input_engine_0 $MIN_INPUT_ENGINE} {$max_input_engine_0 <= $MAX_INPUT_ENGINE} {incr max_input_engine_0} {
		for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
			for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
				if { $number_of_input >= [expr $max_input_engine_0*$max_input_engine_1*$max_input_engine_2]} {
					set generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 ]) [list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 "D"]
				}
			}
		}
	}
...
for	{set number_of_input $MIN_NUMBER_OF_INPUT} {$number_of_input <= $MAX_NUMBER_OF_INPUT} {incr number_of_input}	{
	...
	for {set max_input_engine_0 $MIN_INPUT_ENGINE} {$max_input_engine_0 <= $MAX_INPUT_ENGINE} {incr max_input_engine_0} {
		for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
			...
			set generic_array([list $number_of_input $max_input_engine_0 $max_input_engine_1 ]) [list $number_of_input $max_input_engine_0 $max_input_engine_1]
	...
	for {set max_input_engine_0 $MIN_INPUT_ENGINE} {$max_input_engine_0 <= $MAX_INPUT_ENGINE} {incr max_input_engine_0} {
		for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
			...
			if { $number_of_input < $max_input_engine_0 } {
				...
				set generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 ]) [list $number_of_input $number_of_input $MIN_INPUT_ENGINE]
			}
...
# Si utilizzano tutti gli inpout della prima pipeline ma non della seconda
for	{set number_of_input $MIN_NUMBER_OF_INPUT} {$number_of_input <= $MAX_NUMBER_OF_INPUT} {incr number_of_input}	{
	...
	for {set max_input_engine_0 $MIN_INPUT_ENGINE} {$max_input_engine_0 <= $MAX_INPUT_ENGINE} {incr max_input_engine_0} {
		for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
			...
			if { $number_of_input >= $max_input_engine_0 & $number_of_input < [expr $max_input_engine_0*$max_input_engine_1]} {

				set max_input_engine_0_res [div_exc $number_of_input $max_input_engine_0]

				if { $max_input_engine_0_res == 1} {
					set max_input_engine_0_res $MIN_INPUT_ENGINE
				}

				set generic_array_flt([list $number_of_input $max_input_engine_0 $max_input_engine_1 ]) [list $number_of_input $max_input_engine_0 $max_input_engine_0_res]
...
for	{set number_of_input $MIN_NUMBER_OF_INPUT} {$number_of_input <= $MAX_NUMBER_OF_INPUT} {incr number_of_input}	{
	...
	for {set max_input_engine_0 $MIN_INPUT_ENGINE} {$max_input_engine_0 <= $MAX_INPUT_ENGINE} {incr max_input_engine_0} {
		for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
			...
			if { $number_of_input >= [expr $max_input_engine_0*$max_input_engine_1]} {
			...
			for {set max_input_engine_1 $MIN_INPUT_ENGINE} {$max_input_engine_1 <= $MAX_INPUT_ENGINE} {incr max_input_engine_1} {
				for {set max_input_engine_2 $MIN_INPUT_ENGINE} {$max_input_engine_2 <= $MAX_INPUT_ENGINE} {incr max_input_engine_2} {
					for {set max_input_engine_3 $MIN_INPUT_ENGINE} {$max_input_engine_3 <= $MAX_INPUT_ENGINE} {incr max_input_engine_3} {
						...
						set count_all [expr $count_all +1]


						if { $generics_array_flt_set != $ref } {
							set results([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 ])  [concat $generics_array_flt_set "SYNTH"]
							set ref $generics_array_flt_set
							set count [expr $count +1]
						} else {

							set results([list $number_of_input $max_input_engine_0 $max_input_engine_1 $max_input_engine_2 $max_input_engine_3 ]) [concat $generics_array_flt_set]
						}
