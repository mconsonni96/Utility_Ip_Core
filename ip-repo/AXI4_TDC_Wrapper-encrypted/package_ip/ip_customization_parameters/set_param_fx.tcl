...
# ----------------------- Text Type (String) -----------------------------------
proc set_param_bitString {param default length enablement editable dependency tooltip display_name} \
{
	# Name of the Parameter
	set_property widget {hexEdit} [ipgui::get_guiparamspec -name $param -component [ipx::current_core] ]

	# Set Type
	set_property value_format bitString [ipx::get_user_parameters $param -of_objects [ipx::current_core]]
	set_property value_format bitString [ipx::get_hdl_parameters $param -of_objects [ipx::current_core]]
	...
	set_property value_bit_string_length $length [ipx::get_user_parameters $param -of_objects [ipx::current_core]]
	set_property value_bit_string_length $length [ipx::get_hdl_parameters $param -of_objects [ipx::current_core]]
