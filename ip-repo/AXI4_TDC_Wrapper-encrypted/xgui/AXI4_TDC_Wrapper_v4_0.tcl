...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "PW_StretcherLength"
  ipgui::add_param $IPINST -name "PW_Divider"
  ipgui::add_param $IPINST -name "TDC_CHANNEL_N"
  ipgui::add_param $IPINST -name "TDC_ENABLE_DEBUG_PORTS"
