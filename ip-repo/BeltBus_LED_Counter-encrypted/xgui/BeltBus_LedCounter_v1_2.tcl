...
proc update_PARAM_VALUE.LEDS_BOARD_INTERFACE { PARAM_VALUE.LEDS_BOARD_INTERFACE } {
	# Procedure called to update LEDS_BOARD_INTERFACE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.LEDS_BOARD_INTERFACE { PARAM_VALUE.LEDS_BOARD_INTERFACE } {
	# Procedure called to validate LEDS_BOARD_INTERFACE
	return true
}
