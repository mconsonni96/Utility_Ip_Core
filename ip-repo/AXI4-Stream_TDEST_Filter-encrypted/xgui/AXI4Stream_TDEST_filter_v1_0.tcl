...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "SID_1" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SID_2" -parent ${Page_0}
...
proc update_PARAM_VALUE.SID_1 { PARAM_VALUE.SID_1 } {
	# Procedure called to update SID_1 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SID_1 { PARAM_VALUE.SID_1 } {
	# Procedure called to validate SID_1
	return true
}

proc update_PARAM_VALUE.SID_2 { PARAM_VALUE.SID_2 } {
	# Procedure called to update SID_2 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SID_2 { PARAM_VALUE.SID_2 } {
	# Procedure called to validate SID_2
	return true
}
...
proc update_MODELPARAM_VALUE.SID_1 { MODELPARAM_VALUE.SID_1 PARAM_VALUE.SID_1 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SID_1}] ${MODELPARAM_VALUE.SID_1}
}

proc update_MODELPARAM_VALUE.SID_2 { MODELPARAM_VALUE.SID_2 PARAM_VALUE.SID_2 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SID_2}] ${MODELPARAM_VALUE.SID_2}
}
