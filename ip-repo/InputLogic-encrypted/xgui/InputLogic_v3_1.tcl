...
proc update_PARAM_VALUE.INPUT_DIFF_CH_TDC_BOARD_INTERFACE { PARAM_VALUE.INPUT_DIFF_CH_TDC_BOARD_INTERFACE } {
	# Procedure called to update INPUT_DIFF_CH_TDC_BOARD_INTERFACE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.INPUT_DIFF_CH_TDC_BOARD_INTERFACE { PARAM_VALUE.INPUT_DIFF_CH_TDC_BOARD_INTERFACE } {
	# Procedure called to validate INPUT_DIFF_CH_TDC_BOARD_INTERFACE
	return true
}
