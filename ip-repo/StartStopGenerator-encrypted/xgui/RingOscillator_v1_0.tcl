...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BIT_HALF_DIVIDER" -parent ${Page_0}
...
proc update_PARAM_VALUE.BIT_HALF_DIVIDER { PARAM_VALUE.BIT_HALF_DIVIDER } {
	# Procedure called to update BIT_HALF_DIVIDER when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BIT_HALF_DIVIDER { PARAM_VALUE.BIT_HALF_DIVIDER } {
	# Procedure called to validate BIT_HALF_DIVIDER
	return true
}
...
proc update_MODELPARAM_VALUE.BIT_HALF_DIVIDER { MODELPARAM_VALUE.BIT_HALF_DIVIDER PARAM_VALUE.BIT_HALF_DIVIDER } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BIT_HALF_DIVIDER}] ${MODELPARAM_VALUE.BIT_HALF_DIVIDER}
}
