...
proc init_gui { IPINST } {
  ...
  #Adding Group
  set Type_of_Clock [ipgui::add_group $IPINST -name "Type of Clock" -parent ${Page_0} -display_name {Select Type of Clock} -layout horizontal]
  set_property tooltip {Select Type of Clock} ${Type_of_Clock}
  ipgui::add_param $IPINST -name "CLK_SELECT" -parent ${Type_of_Clock}
  #Adding Group
  set Principal_Divider [ipgui::add_group $IPINST -name "Principal Divider" -parent ${Type_of_Clock} -display_name {Selected Clock Half Divider}]
  set_property tooltip {Selected Clock Half Divider} ${Principal_Divider}
  ipgui::add_param $IPINST -name "HALF_DIVIDER" -parent ${Principal_Divider}


  #Adding Group
  set Extra_Divder [ipgui::add_group $IPINST -name "Extra Divder" -parent ${Page_0} -display_name {External Divder}]
  set_property tooltip {External Divder} ${Extra_Divder}
  ipgui::add_param $IPINST -name "DIVIDER_INIT" -parent ${Extra_Divder}

  #Adding Group
  set Start/Stop_Dalay [ipgui::add_group $IPINST -name "Start/Stop Dalay" -parent ${Page_0}]
  set_property tooltip {Start/Stop Dalay} ${Start/Stop_Dalay}
  ipgui::add_param $IPINST -name "START_STOP_DALAY_NUM_CARRY_BLOCK" -parent ${Start/Stop_Dalay}
