...
This field CAN BE different from BeltBus BIT_NUM_CH.}
  ...
  ipgui::add_param $IPINST -name "INCLUDE_EDGE_BIT" -parent ${Compressor_settings}
...
proc update_PARAM_VALUE.INCLUDE_EDGE_BIT { PARAM_VALUE.INCLUDE_EDGE_BIT } {
	# Procedure called to update INCLUDE_EDGE_BIT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.INCLUDE_EDGE_BIT { PARAM_VALUE.INCLUDE_EDGE_BIT } {
	# Procedure called to validate INCLUDE_EDGE_BIT
	return true
}
...
proc update_MODELPARAM_VALUE.INCLUDE_EDGE_BIT { MODELPARAM_VALUE.INCLUDE_EDGE_BIT PARAM_VALUE.INCLUDE_EDGE_BIT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.INCLUDE_EDGE_BIT}] ${MODELPARAM_VALUE.INCLUDE_EDGE_BIT}
}
