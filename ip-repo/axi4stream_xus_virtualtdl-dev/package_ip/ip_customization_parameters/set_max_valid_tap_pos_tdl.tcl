...
set_param_long_range $name $MIN_MAX_VALID_TAP_POS $MAX_MAX_VALID_TAP_POS $DEFAULT_MAX_VALID_TAP_POS $enablement $editable $dependency $tooltip $display_name
# ----------------------------------------------
