...
proc init_gui { IPINST } {
  ...
  set AXI4_LENGTH [ipgui::add_param $IPINST -name "AXI4_LENGTH" -parent ${Page_0}]
  set_property tooltip {Positive to specify the length of the data of AXI} ${AXI4_LENGTH}
  #Adding Group
  set Calibrator_Dimenstion [ipgui::add_group $IPINST -name "Calibrator Dimenstion" -parent ${Page_0} -display_name {Calibrator Settings}]
  ...
  set_property tooltip {Debug} ${Debug}
  set DEBUG_MODE_CT [ipgui::add_param $IPINST -name "DEBUG_MODE_CT" -parent ${Debug}]
  set_property tooltip {Allow to tune in real-time the calibration and read the CalibTable} ${DEBUG_MODE_CT}
  set DEBUG_MODE_CC [ipgui::add_param $IPINST -name "DEBUG_MODE_CC" -parent ${Debug}]
  set_property tooltip {Allow to tune in real-time the calibration and read the curve} ${DEBUG_MODE_CC}
