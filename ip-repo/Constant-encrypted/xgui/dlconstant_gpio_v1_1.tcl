...
proc update_PARAM_VALUE.CONSTANT_BOARD_INTERFACE { PARAM_VALUE.CONSTANT_BOARD_INTERFACE } {
	# Procedure called to update CONSTANT_BOARD_INTERFACE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CONSTANT_BOARD_INTERFACE { PARAM_VALUE.CONSTANT_BOARD_INTERFACE } {
	# Procedure called to validate CONSTANT_BOARD_INTERFACE
	return true
}
