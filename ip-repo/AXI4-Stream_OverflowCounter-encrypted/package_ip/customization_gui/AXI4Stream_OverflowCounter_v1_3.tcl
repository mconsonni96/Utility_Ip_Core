...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set Overflow_Counter [ipgui::add_page $IPINST -name "Overflow Counter"]
  set BIT_COARSE [ipgui::add_param $IPINST -name "BIT_COARSE" -parent ${Overflow_Counter}]
  set_property tooltip {Bit Coarse Counter dimension} ${BIT_COARSE}
  set BIT_FID [ipgui::add_param $IPINST -name "BIT_FID" -parent ${Overflow_Counter}]
  set_property tooltip {Bit reserver to the FID of the Belt Bus used to identify properly the timestamps} ${BIT_FID}
  set BIT_RESOLUTION [ipgui::add_param $IPINST -name "BIT_RESOLUTION" -parent ${Overflow_Counter}]
