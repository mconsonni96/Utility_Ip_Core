...
proc init_gui { IPINST } {
  ...
  set BIT_OVERFLOW [ipgui::add_param $IPINST -name "BIT_OVERFLOW" -parent ${Average_Settings}]
  set_property tooltip {Variable that sets the dimension of the overflow field} ${BIT_OVERFLOW}
  set CH_SYNC [ipgui::add_param $IPINST -name "CH_SYNC" -parent ${Average_Settings}]
  set_property tooltip {Variable that specifies the synchronization channel} ${CH_SYNC}
  set EXPSAMPLE [ipgui::add_param $IPINST -name "EXPSAMPLE" -parent ${Average_Settings}]
  ...
  set EXPDIVISION [ipgui::add_param $IPINST -name "EXPDIVISION" -parent ${Average_Settings}]
