...
proc init_gui { IPINST } {
  ...
  set C_S00_AXI_ADDR_ABS [ipgui::add_param $IPINST -name "C_S00_AXI_ADDR_ABS" -parent ${Page_0}]
  set_property tooltip {Absolute address on AXI4-Lite bus (used for autopush)} ${C_S00_AXI_ADDR_ABS}
  #Adding Group
