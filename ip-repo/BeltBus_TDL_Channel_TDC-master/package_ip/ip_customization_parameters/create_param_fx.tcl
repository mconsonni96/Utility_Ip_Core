...
proc create_param_long_range {param min max default enablement editable dependency tooltip display_name} \
{

    # Create User Parameter
    ipx::add_user_parameter $param [ipx::current_core]
    set_property value_resolve_type user [ipx::get_user_parameters $param  -of_objects [ipx::current_core]]
    ipgui::add_param -name $param -component [ipx::current_core]
...
# ----------------------- Long Type with list ----------------------------------
proc create_param_long_list {param list default enablement editable dependency tooltip display_name} \
{
	# Create User Parameter
	ipx::add_user_parameter $param [ipx::current_core]
	set_property value_resolve_type user [ipx::get_user_parameters $param  -of_objects [ipx::current_core]]
...
# ---------------------- Bool Type (Boolean) -----------------------------------
proc create_param_bool {param default enablement editable dependency tooltip display_name} \
{
	# Create User Parameter
	ipx::add_user_parameter $param [ipx::current_core]
	set_property value_resolve_type user [ipx::get_user_parameters $param  -of_objects [ipx::current_core]]
...
# ----------------------- List Type (String) -----------------------------------
proc create_param_string_list {param list default enablement editable dependency tooltip display_name} \
{
	# Create User Parameter
	ipx::add_user_parameter $param [ipx::current_core]
	set_property value_resolve_type user [ipx::get_user_parameters $param  -of_objects [ipx::current_core]]
...
# ----------------------- Text Type (String) -----------------------------------
proc create_param_string_text {param default enablement editable dependency tooltip display_name} \
{
	# Create User Parameter
	ipx::add_user_parameter $param [ipx::current_core]
	set_property value_resolve_type user [ipx::get_user_parameters $param  -of_objects [ipx::current_core]]
...
# ----------------------- Board IF Type (String) -------------------------------
proc create_param_string_boardfile {param} \
{
	# Create User Parameter
	ipx::add_user_parameter $param [ipx::current_core]
	set_property value_resolve_type user [ipx::get_user_parameters $param  -of_objects [ipx::current_core]]
	...
	# Set Default
	set_property value Custom [ipx::get_user_parameters $param -of_objects [ipx::current_core]]
