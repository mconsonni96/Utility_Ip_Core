...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MAX_SYNC_DIVISION" -parent ${TDC_settings}
...
proc update_PARAM_VALUE.MAX_SYNC_DIVISION { PARAM_VALUE.MAX_SYNC_DIVISION } {
	# Procedure called to update MAX_SYNC_DIVISION when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MAX_SYNC_DIVISION { PARAM_VALUE.MAX_SYNC_DIVISION } {
	# Procedure called to validate MAX_SYNC_DIVISION
	return true
}
...
proc update_MODELPARAM_VALUE.MAX_SYNC_DIVISION { MODELPARAM_VALUE.MAX_SYNC_DIVISION PARAM_VALUE.MAX_SYNC_DIVISION } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MAX_SYNC_DIVISION}] ${MODELPARAM_VALUE.MAX_SYNC_DIVISION}
}
